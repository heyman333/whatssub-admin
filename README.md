...
6. [Know how to localize your project](https://github.com/dooboolab/whatssub-admin/blob/master/STRINGS.ts).
  - [Example]()
7. [Know how to place your `retina image` into your project](https://github.com/dooboolab/whatssub-admin/blob/master/src/utils/Icons.ts).
8. Know how to use `styled-component`.
9. [Know how to implement theming with styled-component](https://github.com/dooboolab/whatssub-admin/blob/master/src/theme.ts).
  - [Dark Mode]
